...
public class AESUtils {
    ...
    // This method initializes the SecretKey using the key retrieved from application.properties
    @PostConstruct
    public void init() {
    ...
    // Note: This method is static to allow access without creating an instance of AESUtils
